...
public class SpiceJet {
    ...
    public static void ChoosingTheRadioButtonForTrip(WebDriver driver) {
        ...
        // ? sometime enable or disable will not work on that time examine carefully html
    ...
    public static void ClickOnSearch(WebDriver driver) {
        ...
        System.out.println(driver.findElement(By.xpath("//input[@name='ctl00$mainContent$btn_FindFlights']")).isEnabled());
    }
